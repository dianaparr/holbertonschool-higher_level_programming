#!/usr/bin/python3
"""
Module of python called model_state_delete_a
"""
...
def main():
    ...
    # Querying data:
    # When synchronize_session is used, matching objects within
    # the Session will be marked as deleted and expunged.
    del_queryDB = session.query(State).filter(State.name.like('%a%')).delete(
